...
<body>
	...
	<% 
       ...
       if(Error != null){
    	   if(Error.equals("emailinDB"))
    	   {%>
	<br>
	<div class="mx-auto flex flex-wrap mb-5">
		<a class="mx-auto text-xl font-serif">Signed Up Already! Please Log in!</a>
	</div>

	<% }}%>
	<div
		class="container mx-auto flex flex-wrap p-5 flex-col items-center w-full max-w-full">
		<h1 class="text-3xl font-serif">Login here!</h1>
		<br>
		<form name="loginForm" action="loginauth" method="POST"
			class="text-2xl font-serif bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
			<div class="mb-4">
		...
		<form action="newpost" method="POST"></form>
		<br>
		<div class="mx-auto flex mb-5">

			<a class="text-xl font-serif" href="register.jsp">Don't have an
